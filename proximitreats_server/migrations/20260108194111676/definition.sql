...
--
-- Foreign relations for "shops" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('proximitreats', '20260108194111676', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260108194111676', "timestamp" = now();
